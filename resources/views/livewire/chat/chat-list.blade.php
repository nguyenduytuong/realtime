                        ...
                        <aside class="grid grid-cols-12 w-full">
                            ...
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                ...
                                <path
                                    ...
                                    <p class=" grow truncate text-sm font-[100]">lorem ipsum Paste the SVG right into
                                        your
                                        project's code.</p>
                                    {{-- unread count --}}
                                    <span
                                        class=" font-bold p-px px-2 text-sm shrink-0 rounded-full bg-blue-500 text-white">5</span>
                                </div>
                            </a>
