    ...
    <div class=" border-b flex flex-col overflow-y-scroll grow h-full">
        ...
        <main
            ...
            @if ($loadedMessages)
                @foreach ($loadedMessages as $message)
                    <div @class([
                        'max-w-[85%] md:max-w-[78%] flex-auto gap-2 ralative mt-2',
                        ...
                        <div @class([
                            ...
                            <div class=" ml-auto flex gap-2">
                                ...
                                {{-- message status, only if message belongs auth --}}
        ...
        <footer class=" shrink-0 z-10 bg-white inset-x-0">
            <div class=" p-2 border-t">
                <form x-data="{ body: @entangle('body') }" wire:submit.prevent="sendMessage" method="POST" autocapitalize="off">
                    @csrf
                    <input type="hidden" autocomplete="false" type="display:none">
                    <div class=" grid grid-cols-12">
                        <input x-model.defer="body" type="text" autocomplete="off" autofocus
                            placeholder="write your message here" maxlength="1700"
                            class=" col-span-10 bg-gray-100 border-0 outline-0 focus:ring-0 focus:border-0 hover:ring-0 rounded-lg focus:outline-none">
